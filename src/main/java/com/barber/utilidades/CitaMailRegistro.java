...
public abstract class CitaMailRegistro {
    ...
    public static void recuperarClaves(String nombreUsuario,  String correoPara, String claveNueva) {
        ...
        try {
            ...
            mensage.setSubject("Hola! ha sido registrado exitosamente en Urban baber shop.");
            mensage.setContent("<center> "
                    ...
                    + ".<br/>"
                    + "Recuerda agendar una cita con uno de nuestros barberos."
                    + "<br/>"
                    + "Te esperamos!",
                    "text/html");
